                    ...
                    <el-form :model="form" ref="form" label-width="80px" label-position='top'>
                        ...
                        <el-row>
                          <el-col :span="24">
                              <el-form-item label="分组和接口名称" prop="groupName"  class="change-label-calss">
                                <el-cascader size="small" :options="menuList" v-model="form.groupName" :show-all-levels="false"
                        ...
                        <el-row>
                          <el-col :span="24">
                                ...
                                :params="form.params" :jsonVariable="form.jsonVariable" :authType="form.authType"></TestTabs>
                          </el-col>
                        </el-row>
