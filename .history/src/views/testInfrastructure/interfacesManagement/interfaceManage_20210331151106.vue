            ...
            <div class="main-page">
                ...
                <el-dialog :title="getTitle" :visible.sync="dialogVisible" :before-close="handleClose" width="60%">
                    <el-form :model="form" ref="form" label-width="80px" label-position='top'>
                        <el-row>
                          <el-col :span="12">
                              <el-form-item class="item-style" label="开发状态" prop="status">
                          ...
                          <el-col :span="11" :offset="1">
                              <el-form-item class="item-style" label="标签" prop="tags">
                                    <el-input
                                        class="input-new-tag"
                                        v-if="inputVisible"
                                        v-model="inputValue"
                        ...
                        <el-row>
                          <el-col :span="24">
                              <el-form-item label="URL Path" prop="urlPath">
                                <el-select size="small" v-model="form.protocol" placeholder="请选择" style="width:10%">
                                    <el-option
                                ...
                                <el-select size="small" v-model="form.method" placeholder="请选择" style="width:10%">
                                    <el-option
                                ...
                                <el-tooltip class="item" effect="dark" content="接口路径，建议将环境信息写到项目环境中" placement="top-start">
                                    <el-input v-model="form.urlPath" size="small" placeholder="接口路径" style="width:79%">
                                    </el-input>
                                </el-tooltip>
                            </el-form-item>
                          </el-col>
                        ...
                        <el-row>
                          <el-col :span="24">
                              <el-form-item label="分组和接口名称" prop="groupName">
                                <el-cascader size="small" :options="menuList" v-model="form.groupName" :show-all-levels="false" style="width:20%"> 
                                </el-cascader>
                                <el-tooltip class="item" effect="dark" content="接口名称" placement="top-start">
                                    <el-input v-model="form.interfaceName" size="small" placeholder="接口名称" style="width:79%">
                                    </el-input>
                                </el-tooltip>
                            </el-form-item>
                          </el-col>
