                ...
                <el-row>
                  <el-col :span="2">
                      <template slot-scope="scoped">
                        <el-tag size="middle"  :type="scoped.interfaceData.protocol | getType">
                            {{scoped.interfaceData.protocol | getProtocol}}
                        </el-tag>
                      </template>
                  </el-col>
                  <el-col :span="2">
                    <el-tag size="middle"  :type="scoped.interfaceData.method | getType">
                        {{scoped.interfaceData.method | getMethod}}
                    </el-tag>
                  </el-col>
                  <el-col :span="8">
                    <el-tag size="middle"  :type="scoped.interfaceData.status | getType">
                        {{scoped.interfaceData.status | getStatus}}
                    </el-tag>
                  </el-col>
                </el-row>
