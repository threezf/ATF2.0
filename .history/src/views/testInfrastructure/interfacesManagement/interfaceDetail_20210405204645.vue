...
export default {
    ...
    filters: {
        getProtocol(val) {
            for ( let item in this.protocols){
              let option = this.protocols[item]
              if(option.value == val){
        ...
        getMethod(val) {
            for ( let item in this.methodOptions){
              let option = this.methodOptions[item]
              if(option.value == val){
        ...
        getStatus(val) {
            for ( let item in this.statusOptions){
              let option = this.statusOptions[item]
              if(option.value == val){
