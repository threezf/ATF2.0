<template>
    <el-row>
      <el-col class="page-outer" :span="12">
          <sideBar  path-name="TestInfrastructure"
          :firstPathName="firstPathName" :isInterface="isInterface"></sideBar>
      </el-col>
      <el-col :span="12">
          <TestTabs ref="apiFunc">></TestTabs>
      </el-col>
    </el-row>
</template>
<script>
...
export default {
    ...
    data(){
        return {
            pathName:'/testInfrastructure/TestedSystemManagementRouter/testedSystemManagement',
            firstPathName: '测试系统',
            isInterface: true
        }
    },
