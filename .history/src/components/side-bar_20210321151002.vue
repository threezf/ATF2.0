...
<!--				<el-divider></el-divider>-->
        ...
        <template v-for="(menu, index) in menuList">
            ...
            <el-menu-item :index="fullPath + '/' + menu.path" :key="index" v-if="(!menu.children || needHideAllChildren(menu)) && !menu.meta.hide && isDisplay">
                <i v-if="menu.meta.icon" :class="menu.meta.icon"></i>
...
export default {
    ...
    mounted() {
        ...
        if(this.$route.path === '/testInfrastructure/TestedSystemManagementRouter/transact'){
