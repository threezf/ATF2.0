...
<!--				<el-divider></el-divider>-->
        ...
        <template v-for="(menu, index) in menuList">
            ...
            <el-menu-item :index="index" :key="index" v-if="(!menu.children || needHideAllChildren(menu)) && !menu.meta.hide">
                <i v-if="menu.meta.icon" :class="menu.meta.icon"></i>
    ...
    computed: {
        menuList() {
            ...
            if (this.firstPathName) {
                ...
                children[1].meta.name = "接口管理"
                children[2].meta.name = "接口测试"
                children[3].meta.name = "测试用例"
                children[4].meta.name = "项目环境"
            }
            if(this.isInterface) {
