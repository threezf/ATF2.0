<template>
    <div>
        <template v-for="menu in menuData">
            <el-submenu :key="menu.id" :index="menu.id" style="text-align:center;" v-if="menu.children">
                <template slot="title">
                ...
                <el-dropdown @command="handleCommand">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item :command="'0,'+menu.id+','+menu.name"  icon="el-icon-circle-plus-outline">新建子分组</el-dropdown-item>
                            <el-dropdown-item :command="'1,'+menu.id+','+menu.name" icon="el-icon-edit-outline">编辑</el-dropdown-item>
                            <el-dropdown-item :command="'2,'+menu.id+','+menu.name" icon="el-icon-delete">删除</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </span>
                </template>
