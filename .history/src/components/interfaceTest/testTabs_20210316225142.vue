...
<div>
    <el-tabs style="margin: 0 0 0 10px" v-model="bodyShow">
        ...
        <el-tab-pane label="请求体" name="second" :disabled="apiMsgData.method === 'GET'">
        ...
        <el-tab-pane label="Query请求参数" name="third">
            <el-table :data="apiMsgData.extract" size="mini" stripe :show-header="true"
                        border
                        class="h-b-e-a-style"
                        :row-style="{'background-color': 'rgb(250, 250, 250)'}">
                <el-table-column property="key" label="Key" header-align="center" minWidth="100">
        ...
        <el-tab-pane label="权限校验" name="fourth">
            <el-form>
                <el-form-item class="bottomForm" label="Authorization Type">
                    <el-select style="width:240px" size="small" class="typeSelect" v-model="apiMsgData.selectedAuthorization">
