  ...
  <el-table
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-tag size="small"
                :type="tableData[scope.$index]['status'] === 0 ?
                'success' : tableData[scope.$index]['status'] === 1 ? 
                'primary' : 'danger'">
            {{tableData[scope.$index]['status'] | getStatus}}
        </el-tag>
    </template>
    <el-table-column
      property="name"
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-tag size="small"
                :type="tableData[scope.$index]['method'] === 0 ?
                'success' : tableData[scope.$index]['method'] === 1 ? 
                'primary' :  tableData[scope.$index]['method'] === 2 ? 'warning' : 'danger'">
