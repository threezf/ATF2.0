        ...
        <template v-for="menu in menuData">
            ...
            <el-menu-item :key="menu.index" :index="menu.index" style="text-align:center" v-else>
                    ...
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item :command="new Map(0,menu.index)" icon="el-icon-circle-plus-outline">新建子分组</el-dropdown-item>
                            <el-dropdown-item :command="new Map(1,menu.index)" icon="el-icon-edit-outline">编辑</el-dropdown-item>
                            <el-dropdown-item :command="new Map(2,menu.index)" icon="el-icon-delete">删除</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
            </el-menu-item>
        </template>
