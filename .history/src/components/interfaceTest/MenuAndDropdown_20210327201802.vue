        ...
        <template v-for="menu in menuData">
            <el-submenu :key="menu.index" :index="menu.index" style="text-align:center;" v-if="menu.children">
                ...
                <el-dropdown @command="handleCommand">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item :command="'0,'+menu.index"  icon="el-icon-circle-plus-outline">新建子分组</el-dropdown-item>
                            <el-dropdown-item :command="'1,'+menu.index" icon="el-icon-edit-outline">编辑</el-dropdown-item>
                            <el-dropdown-item :command="'2,'+menu.index" icon="el-icon-delete">删除</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </span>
                </template>
            ...
            <el-menu-item :key="menu.index" :index="menu.index" style="text-align:center" v-else>
                    ...
                    <el-dropdown @command="handleCommand">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item :command="'0,'+menu.index+','+menu.name" icon="el-icon-circle-plus-outline">新建子分组</el-dropdown-item>
                            <el-dropdown-item :command="'1,'+menu.index+','+menu.name" icon="el-icon-edit-outline">编辑</el-dropdown-item>
                            <el-dropdown-item :command="'2,'+menu.index+','+menu.name" icon="el-icon-delete">删除</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
            </el-menu-item>
        </template>
        <el-dialog :title="getTitleName" :visible.sync="isDialogVisible" :before-close="handleClose" width="30%">
            <el-form :rules="rules" :model="groupForm" ref="groupForm" label-width="80px" status-icon>
                ...
                <el-row class="buttons_row">
                    <el-button type="primary" size="small" @click="submitForm('form')">{{getButtonName}}</el-button>
