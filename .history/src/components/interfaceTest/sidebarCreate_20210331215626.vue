<template>
    <div :class="isCollapse?'narrow-side-bar':'side-bar'">
        <el-menu
            ...
            <!-- 引入组件 -->
            <MenuAndDropdown :menuData="menuList" :isCollapse="isCollapse" :transactId="transactId"></MenuAndDropdown>
        </el-menu>
...
export default {
        ...
        data() {
            return {
                ...
                autId: Number(localStorage.getItem('transactId'))
            }
        },
        props:{
            getTableDataByIndex: {
        ...
        methods: {
            handleSelect(key, keyPath) {
                ...
                this.getTableDataByIndex(keyPath[length-1])
            },
            newGroup(){
                this.modelFlag = 1
