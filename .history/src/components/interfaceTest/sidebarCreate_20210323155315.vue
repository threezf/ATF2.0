<template>
    <div :class="isCollapse?'narrow-side-bar':'side-bar'">
        <el-menu
                ...
                :collapse="isCollapse">
                <el-row>
                    <el-button v-show="!isCollapse" class="newInterface-button"  @click="newInterface" type="primary" size="small">
            ...
            <!-- 引入组件 -->
            <MenuAndDropdown :menuData="menuList" :isCollapse="isCollapse" class="menu-dropdown"></MenuAndDropdown>
