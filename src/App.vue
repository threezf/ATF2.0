    ...
    <el-dialog :visible.sync="dialogVisible" width="25%" title="修改密码">
        <el-form :rules="rules" label-width="100px" :model="ruleForm" ref="ruleForm">
            <el-form-item prop="oldPass" label="原密码">
                <el-input class="el-input-style" v-model="ruleForm.oldPass" type="password" placeholder="请输入原密码" show-password clearable>
                </el-input>
            </el-form-item>
            <el-form-item prop="newPass" label="新密码">
                <el-input class="el-input-style" v-model="ruleForm.newPass" placeholder="请输入新密码" show-password type="password" clearable>
                </el-input>
            </el-form-item>
            <el-form-item prop="surePass" label="确认密码">
                <el-input class="el-input-style" v-model="ruleForm.surePass" type="password" placeholder="确认密码" show-password clearable>
                </el-input>
            </el-form-item>
        </el-form>
