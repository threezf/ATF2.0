    ...
    <el-tabs v-model="bodyShow" type="border-card">
            ...
            <el-table :data="headers"
                ...
                <el-table-column property="key" label="Key" header-align="center" minWidth="100">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.name" size="mini" placeholder="key" :disabled="isRunModel">
                        </el-input>
                    </template>
                </el-table-column>
                <el-table-column property="value" label="Value" header-align="center" minWidth="200" >
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.val" size="mini" placeholder="value"  :disabled="isRunModel">
                        </el-input>
                    </template>
                </el-table-column>
                <el-table-column label="Description" header-align="center" minWidth="80">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.desc" size="mini" placeholder="备注"  :disabled="isRunModel">
                        </el-input>
                    </template>
                </el-table-column>
        ...
        <el-tab-pane label="请求体" name="second" >
            <el-form :inline="true" class="demo-form-inline" style="margin-top: 10px; display: flex; align-items: center;">
                ...
                <el-button v-if="!isRunModel" size="mini" type="text" style="margin-top: -10px" @click="downloadTemplate">下载模板</el-button>
            </el-form>
            <hr style="height:1px;border:none;border-top:1px solid rgb(241, 215, 215);"/>
					<el-button v-if="!isRunModel" type="primary" size="small" @click="importTemplate">导入
					</el-button>
            <div v-if="bodyType === '1'">
            ...
            <el-table :data="bodys"
                ...
                <el-table-column label="KEY" header-align="center" minWidth="100">
                    <template slot-scope="scope">
                        <el-input  :disabled="isRunModel" v-model="scope.row.name" size="mini">
                        </el-input>
                    </template>
                </el-table-column>
                <el-table-column label="TYPE" header-align="center" width="100">
                    <template slot-scope="scope">
                        <el-select :disabled="isRunModel" v-model="scope.row.type" size="mini">
                ...
                <el-table-column label="DESCRIPTION" header-align="center" minWidth="80">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.desc" size="mini" :disabled="isRunModel">
                        </el-input>
                    </template>
                </el-table-column>
        ...
        <el-tab-pane label="请求参数" name="third">
            <el-table :data="params" size="mini" stripe :show-header="true"
                ...
                <el-table-column property="key" label="Key" header-align="center" minWidth="100">
                    <template slot-scope="scope">
                        <el-input :disabled="isRunModel" v-model="scope.row.name" size="mini" placeholder="Key">
                        </el-input>
                    </template>
                </el-table-column>
                <el-table-column property="value" label="Value" header-align="center" minWidth="200">
                    <template slot-scope="scope">
                        <el-input :disabled="isRunModel" v-model="scope.row.val" size="mini" placeholder="Value">
                        </el-input>
                    </template>
                </el-table-column>
                <el-table-column label="Description" header-align="center" minWidth="80">
                    <template slot-scope="scope">
                        <el-input :disabled="isRunModel" v-model="scope.row.desc" size="mini" placeholder="Description">
                        </el-input>
                    </template>
                </el-table-column>
                <el-table-column property="value" label="操作" header-align="center" width="120" align="center">
        ...
        <el-tab-pane label="权限校验" name="fourth">
            <el-row>
                ...
                <el-select :disabled="isRunModel" size="small" v-model="selectedAuthType">
