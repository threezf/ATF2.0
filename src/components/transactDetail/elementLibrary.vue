      ...
      <div class="ele-container">
        <div class="ele-left">
          <el-card class="box-card">
            ...
            <div class="content">
              <el-row>
                <el-button size="mini" type="primary" @click="addUIShow">添加UI</el-button>
                <el-button size="mini" type="primary" @click="deleteUIShow">删除UI</el-button>
                <el-button size="mini" type="primary" @click="addEleShow">添加元素</el-button>
              ...
              <div v-if="infoCardType !== undefined">
                <el-row v-if=" editFlag ">
                  <el-col :span="5" :offset="17">
                    <el-button @click="editFlag = false" type="primary" size="small">编辑</el-button>
                  </el-col>
                </el-row>
                <el-row v-else>
                  ...
                  <el-col :span="5">
                    <el-button v-if="infoCardType === true" @click="modifySingleElement" type="primary" size="small">保存</el-button>
