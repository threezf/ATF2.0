            ...
            <div class="ele-right">
                <el-card class="box-card">
                    ...
                    <div class="content">
                        ...
                        <el-table v-if="infoCardType" border ref="multipleTable" :data="mainProperties" tooltip-effect="dark" style="width: 86%; margin-left: 8%" @selection-change="handleSelectionChange">
...
export default {
    ...
    methods: {
        ...
        downloadTools() {
            ...
            // window.location = "http://10.101.167.184:9090/atf-data/atf-recorder.zip"
        },
        downloadTemp() {
            let url =
                "http://140.143.16.21:9090/atfcloud2.0a/elementRepository/getExcelTemporary/" +
                // "http://10.101.167.184:9090/atfcloud2.0a/elementRepository/getExcelTemporary/" +
                this.autId;
            console.log(url);
