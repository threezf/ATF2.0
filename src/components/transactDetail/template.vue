<template>
  <div class="page-outer">
              ...
              <el-table-column prop="arguments" label="参数">
                <template slot-scope="scope">
                  <div v-if="scope.row.arguShow">
                    <el-row
                      v-for="item in scope.row.arguments"
                      :key="item.index"
                    >
                      <el-col :span="5">
                        <span> 名称 </span>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" type="primary" @click="addTemplate"
          >确 定</el-button
        >
        <el-button size="small" @click="addTemplateDialog = false"
          >取 消</el-button
        >
      </div>
    </el-dialog>
    <el-dialog
      :title="'删除' + name"
      :visible.sync="deleteTemplateDialog"
      width="30%"
    >
      <span :offset="2">确定要删除该{{ name }}吗？</span>
      <div slot="footer" class="dialog-footer">
        <el-button size="small" type="primary" @click="deleteTemplate"
          >确 定</el-button
        >
        <el-button size="small" @click="deleteTemplateDialog = false"
          >取 消</el-button
        >
      </div>
    </el-dialog>
