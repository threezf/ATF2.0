...
<div class="page-base-inner">
    <el-container>
        ...
        <el-main class="el-main-base-inner">
            ...
            <!--新增和修改对话框-->
            <el-dialog :close-on-click-modal="false"  width="26%" :title="dialogTitle" :visible.sync="dialogVisible" :before-close="handleBeforeClose">
            ...
            <!--导入对话框-->
            <el-dialog :close-on-click-modal="false"  width="26%" :title="dialogTitle" :before-close="handleBeforeClose" :visible.sync="dialogImportVisible">
