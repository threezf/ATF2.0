    ...
    <el-container>
        <el-main>
            <el-row class="topRow">
                    ...
                    <el-col :span="12">
                        <el-form-item label="被测系统">
                            <el-select v-model="titleForm.selectedSystem" @change="handleSelectChange">
                                ...
                                <el-option v-for="item in searchedSystem(autRespDTOList)" :key="item.id" :value="item.id" :label="item.nameMedium"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="功能点">
                            <el-select v-model="titleForm.selectedFunc" @change="handleFuncChange">
                                <el-input v-model="titleForm.funcSearch"></el-input>
                                <el-option v-for="(item) in transactRespDTOs" :key="item.id" :value="item.id" :label="item.nameMedium">
                                </el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-button type="primary" size="small" icon="el-icon-download" @click="downloadTools">录制工具下载</el-button>
            </el-row>
            <el-tabs @tab-click="handleTabClick" type="border-card" class="mainTab">
                ...
                <el-tab-pane label="元素库">
                    <element-library ref="elelib" :transactId="Number(id)" :repositoryId="Number(elementRepositoryId)" :autId="Number(autId)" :omClassRespDTOList="omClassRespDTOList"></element-library>
                </el-tab-pane>
            </el-tabs>
        </el-main>
    </el-container>
