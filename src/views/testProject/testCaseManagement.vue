		...
		<el-container>
			<el-main>
				...
				<el-scrollbar style="width:100%">
					<el-table stripe :data="testCaseList" border :row-class-name="tableRowClassName" class="table"
										@expand-change="subShow" @selection-change="handleSelectionChange">
...
" row-key="id" class="tabPosition">
										<el-table-column width="48"><i class="el-icon-rank"
																									 style="color:#F56C6C;font-size:16px;cursor: pointer"></i>
										</el-table-column>
						...
						<el-tab-pane label="单用例" name="first" class="addTab">
                         ...
                         addForm.casecode" size="small"></el-input>
												...
												<el-col :span="8" :offset="1">
													<el-button @click="showVisibleS" v-if="buttonS" type="primary" size="small"
																		 icon="el-icon-arrow-down">
														隐藏详情
													</el-button>
											...
											<el-col :span="7">
												<el-form-item label="用例性质" prop="caseproperty" label-width="40%">
													<el-select class="selectWidth" v-model="addForm.caseproperty" size="small">
														<el-option v-for="item in casePropertyList" :key="item.id" :label="item.label"
																			 :value="item.value">
														</el-option>
													</el-select>
												</el-form-item>
								...
								<el-form ref="addForm" :model="addForm">
									<el-row style="padding:0;margin:0" type="flex" justify="center" >
											<el-form-item label="用例编号" prop="casecode" label-width="35%" required>
												...
												<el-col :span="8" :offset="1">
													<el-button @click="showVisibleM" v-if="buttonM" type="primary" size="small"
																		 icon="el-icon-arrow-down">
														隐藏详情
													</el-button>
											...
											<el-form ref="addNodeForm" v-if="item.display" :model="item.addNodeForm">
												...
												<el-row>
													<el-col :span="18" :offset="2">
														<el-form-item label="流程节点编号" prop="actioncode" label-width="35%" required>
															<el-col :span="6">
												...
												<div v-show="item.show">
													...
													<el-row>
														<el-col :span="7">
															<el-form-item label="动作标识" prop="actioncasecode" label-width="40%" required>
				...
				<el-dialog title="导入" :visible.sync="dialogVisibleI" width="30%">
					<!-- ElementUI上传 -->
					<el-upload class="upload-demo in-file" action="" :on-success="changeFile" :on-remove="handleRemove"
										 :file-list="fileList">
