		...
		<el-container>
			<el-main>
							...
							<el-table-column type="expand" >
								<template slot-scope="scope">
									<div class="scrollbar" v-if="scope.row.caseCompositeType=='2'">
										<el-scrollbar style="width:100%">
											<el-table :data="subCaseList" @selection-change="subHandleSelectionChange">
												<el-table-column
													type="selection"/>
												<el-table-column
													label="被测系统"
				...
				<el-dialog
					...
					<el-tabs v-model="activeName" type="card">
							<div>
								<el-form ref="addMultipleForm"  :model="addMultipleForm">
									<el-row>
										<el-col :span="18" :offset="4">
											<el-form-item label="流程节点编号" prop="casecode" label-width="35%" required>
												<el-col :span="8">
													<el-input v-model="addMultipleForm.casecode"></el-input>
												</el-col>
												<el-col :span="8" :offset='1'>
									...
									<div id="addVisibleM" class="notShowAddSingle">
										...
										<el-row>
											<el-col :span="7">
												<el-form-item label="动作标识" prop="caseProperty" label-width="40%">
													<el-input v-model="addSingleForm.testPoint" size="small"></el-input>
												</el-form-item>
											</el-col>
											<el-col :span="7" :offset="1">
												<el-form-item label="步骤顺序号" prop="caseType" label-width="40%">
													<el-input v-model="addSingleForm.testPoint" size="small"></el-input>
													</el-select>
												</el-form-item>
											</el-col>
											<el-col :span="7" :offset="1">
												<el-form-item label="测试点" prop="priority" label-width="40%">
													<el-input v-model="addSingleForm.testPoint" size="small"></el-input>
												</el-form-item>
											</el-col>
										</el-row>
				...
				<el-dialog
					...
					width="30%">
					<el-form ref="outputForm" prop="outputForm" label-width="80px">
						<el-form-item label="导出范围" prop="output">
							<el-input :disabled="true" placeholder="部分"></el-input>
						</el-form-item>
						<div class="in-file">
							<el-button size="small" type="primary" @click="outputTemp">导出</el-button>
							<el-button size="small" type="primary" @click="this.dialogVisibleO = false">取消</el-button>
						</div>
					</el-form>
				</el-dialog>
			</el-main>
