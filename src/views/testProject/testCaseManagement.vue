...
export default {
    ...
    computed: {
        ...
        title() {
			...
			importURL() {
				...
				// return "http://10.101.167.184:9090/atfcloud2.0a/testcase/batchImportTestcase"; // 上传的URL
			},
    },
    created() {
        this.getCase();
    ...
    methods: {
        ...
        downloadTemplate(val) {
            if (val == 0) {
                let url =
                    // "http://10.101.167.184:9090/atfcloud2.0a/testcase/batchImport/file/template/simple";
                ...
                let url =
                    ...
                    // "http://10.101.167.184:9090/atfcloud2.0a/testcase/getStandardExcelTemporary?companyId=" + JSON.parse(localStorage.getItem('loginInfo')).companyId;
                window.location.href = url;
            }
        },
        //选择一级表格
