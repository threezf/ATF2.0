    ...
    <el-container>
      <el-main>
        ...
        <el-row style="padding-top: 20px; padding-bottom: 10px">
          <search
            @getComponentData="searchCase"
            @getTotalCount="searchCase2"
          ></search>
          <!--		   <el-col :span="4">-->
          ...
          >
            <el-table-column type="expand">
              <template slot-scope="scope">
                <div
                  class="scrollbar"
                  v-if="scope.row.caseCompositeType == '2'"
                >
                  <el-table
                    :data="subCaseList"
                  ...
                  >
                    ...
                    <el-table-column
                      ...
                      width="120"
                    />
                    <el-table-column label="评审者" property="reviewerName" />
                    <el-table-column label="执行方式">
                      <template slot-scope="scope">
                        {{ convertExecMe(scope.row.executeMethod) }}
                      </template>
                    </el-table-column>
                    <el-table-column label="测试任务" property="missionName" />
...
>删除
            ...
            <!--		</template>-->
            <!--		</el-table-column>-->
            <el-table-column label="用例编号" property="casecode" />
            <el-table-column label="被测系统" property="autName" />
            <el-table-column label="功能点" property="transName" />
            <el-table-column label="用例组成类型">
              <template slot-scope="scope">
            ...
            <el-table-column label="测试点" property="testPoint" />
        ...
        <el-dialog title="添加用例" :visible.sync="dialogVisible" width="65%">
                ...
                <el-form ref="addForm" :model="addForm">
                  <el-row>
                    <el-col :span="18" :offset="4">
                      ...
                      >
                        <el-col :span="8">
                          <el-input v-model="addForm.casecode"></el-input>
                        </el-col>
                    ...
                    <el-row>
                      ...
                      <el-col :span="7" :offset="1">
                        ...
                        >
                          <el-select
                            class="selectWidth"
                            v-model="addForm.scriptModeFlag"
                            size="small"
                          >
                            <el-option
                    ...
                    <div v-for="item in caseNodeNums" :key="item.id">
                      ...
                      >
                        <el-row style="font-size: 20px; padding-top: 20px">
                          <el-col :span="4" :offset="1"> 流程节点用例 </el-col>
                        </el-row>
                        <el-row>
                          <el-col :span="18" :offset="2">
                            ...
                            >
                              <el-col :span="6">
                                <el-input
                                  v-model="item.addNodeForm.actioncasecode"
                                  size="small"
                                ></el-input>
                              </el-col>
                              ...
                              <el-col :span="5" :offset="1">
                                <el-button
                                  @click="caseNodeNums.splice(item.num - 1, 1)"
                                  type="primary"
                                  size="small"
                                  icon="el-icon-arrow-down"
                                >
                        ...
                        <div v-show="item.show">
                          <el-row>
                            <el-col :span="7">
                              ...
                              >
                                <el-select
                                  class="selectWidth"
                                  v-model="item.addNodeForm.autId"
                                  size="small"
                                  @change="transChange($event)"
                                >
                                  <el-option
                            ...
                            <el-col :span="7" :offset="1">
                              ...
                              >
                                <el-select
                                  class="selectWidth"
                                  v-model="item.addNodeForm.transId"
                                  size="small"
                                  @change="templateChange($event)"
                                >
                                  <el-option
                            ...
                            <el-col :span="7" :offset="1">
                              ...
                              >
                                <el-select
                                  class="selectWidth"
                                  v-model="item.addNodeForm.scriptModeFlag"
                                  size="small"
                                >
                                  <el-option
                                    v-for="item in templateList"
                          ...
                          <el-row>
                            <el-col :span="7">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.actioncode"
                                  size="small"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                            <el-col :span="7" :offset="1">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.steporder"
                                  size="small"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                            <el-col :span="7" :offset="1">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.testpoint"
                                  size="small"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                          ...
                          <el-row>
                            <el-col :span="7">
                              ...
                              >
                                <el-select
                                  class="selectWidth"
                                  v-model="item.addNodeForm.executeMethod"
                                  size="small"
                                >
                                  <el-option
                                    v-for="item in executeMethodList"
                            ...
                            <el-col :span="7" :offset="1">
                              ...
                              >
                                <el-select
                                  class="selectWidth"
                                  v-model="item.addNodeForm.scriptMode"
                                  size="small"
                                >
                                  <el-option
                                    v-for="item in scriptModeList"
                          ...
                          <el-row>
                            <el-col :span="11">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.testdesign"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                            <el-col :span="11" :offset="1">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.prerequisites"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                          </el-row>
                          <el-row>
                            <el-col :span="11">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.teststep"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                            <el-col :span="11" :offset="1">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.datarequest"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                          </el-row>
                          <el-row>
                            <el-col :span="11">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.expectresult"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                            <el-col :span="11" :offset="1">
                              ...
                              >
                                <el-input
                                  v-model="item.addNodeForm.checkpoint"
                                ></el-input>
                              </el-form-item>
                            </el-col>
                          </el-row>
        ...
        >
          <el-tabs v-model="activeName" type="card">
            ...
            <el-row>
              <el-col :span="6" :offset="18">
                <el-button type="primary" size="small" @click="insertNode"
                  >添加</el-button
                >
          ...
          <el-tabs v-model="activeName" type="card">
              ...
              <el-row>
                ...
                <el-col :span="7" :offset="1">
                  ...
                  >
                    <el-select
                      class="selectWidth"
                      v-model="changeForm.scriptModeFlag"
                      size="small"
                    >
                      <el-option
                        v-for="item in templateList"
              ...
              <el-row>
                <el-col :span="7">
                  ...
                  >
                    <el-select
                      class="selectWidth"
                      v-model="changeForm.caseProperty"
                      size="small"
                    >
                      <el-option
                        v-for="item in casePropertyList"
              ...
              <el-row>
                <el-col :span="11">
                  ...
                  >
                    <el-select
                      class="selectWidth"
                      v-model="changeForm.executeMethod"
                      size="small"
                    >
                      <el-option
                        v-for="item in executeMethodList"
            ...
            <el-row>
              <el-col :span="9" :offset="15">
                <el-button type="primary" size="small" @click="changeIm"
                  >更改</el-button
                >
                <el-button type="primary" size="small" @click="toOrigin"
                  >重置</el-button
                >
                <el-button type="primary" size="small" @click="noChangeIm"
                  >取消</el-button
                >
              </el-col>
            </el-row>
        ...
        <el-dialog title="导入" :visible.sync="dialogVisibleI" width="30%">
          ...
          <div>
            ...
            <el-button size="small" type="success" @click="downloadTemplate(0)"
              >模板下载</el-button
            >
          </div>
          <div>
            <el-radio v-model="radio" label="2" class="radio">标准版</el-radio>
            <el-button size="small" type="success" @click="downloadTemplate(1)"
              >模板下载</el-button
            >
          </div>
          <el-divider></el-divider>
          <div class="in-file">
            <el-button size="small" type="primary" @click="uploadTemp"
              >导入</el-button
            >
            <el-button
              size="small"
        ...
        <el-dialog :title="title" :visible.sync="dialogVisibleQ" width="50%">
          <el-form :disabled="!changeFlag" ref="addForm" :model="addForm">
            ...
            <el-row>
              <el-col :span="11">
                <el-form-item
                  ...
                  required
                >
                  <el-input v-model="addForm.testpoint" size="small"></el-input>
                </el-form-item>
              </el-col>

              <el-col :span="11" :offset="1">
                <el-form-item label="版本号" prop="version" label-width="40%">
                  <el-input v-model="addForm.version" size="small"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
              ...
              <el-col :span="11" :offset="1">
                <el-form-item label="评审者" prop="executor" label-width="40%">
                  <el-select
                    class="selectWidth"
                    v-model="addForm.executor"
                    size="small"
            ...
            <el-row>
              <el-col :span="11">
                <el-form-item label="执行者" prop="reviewer" label-width="40%">
                  <el-select
                    class="selectWidth"
                    v-model="addForm.reviewer"
                    size="small"
            ...
            <el-row>
              <el-col :span="6" :offset="18">
                ...
                <el-button
                  type="primary"
                  size="small"
                  @click="dialogVisibleQ = !dialogVisibleQ"
                  >退出</el-button
                >
              </el-col>
            </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      timer: null,
      exportUrl:
        "http://10.101.167.184:8080/atfcloud2.0a/testcase/exportTestCase",
    };
  },
  computed: {
    params() {
  ...
  methods: {
    ...
    changeCaseInfo() {
      ...
      Request({
        ...
        params: {
          ...this.addForm,
          transId:
            _this.row.transName == _this.addForm.transId
              ? _this.row.transId.toString()
              : _this.addForm.transId.toString(),
    ...
    insert(caseCompositeType) {
      ...
      if (caseCompositeType == 2) {
        for (var i = 0; i < _this.caseNodeNum - 1; i++) {
          _this.addForm.actionList.push(_this.caseNodeNums[i].addNodeForm);
        }
      }
      Request({
    ...
    showElement(type) {
      ...
      var caseNodeNum = {
        ...
        addNodeForm: {
          ...
          scriptMode: "1",
          scriptModeFlag:
            _this.templateList.length == 0 ? "" : _this.templateList[0].id,
          steporder: "",
          testdesign: "",
          testpoint: "",
          teststep: "",
      ...
      Request({
        ...
        .then(
          (res) => {
            ...
            _this.caseNodeNums[0].addNodeForm.autId = _this.autList[0].id;
      ...
      Request({
        ...
        .then(
          (res) => {
            ...
            _this.caseNodeNums[0].addNodeForm.transId = _this.transList[0].id;
        ...
        .then(
          (res) => {
            ...
            if (_this.templateList.length == 0) {
              ...
              _this.addForm.scriptModeFlag = _this.templateList[0].id;
              _this.caseNodeNums[0].addNodeForm.scriptModeFlag =
    ...
    changeIm() {
      let data = {};
      this.changeForm.autId == "未选择"
        ? 1
        : (data.autId = this.changeForm.autId);
      this.changeForm.caseProperty == "未选择"
        ? 1
        : (data.caseProperty = this.changeForm.caseProperty);
      this.changeForm.caseType == "未选择"
        ? 1
        : (data.caseType = this.changeForm.caseType);
      this.changeForm.executeMethod == "未选择"
        ? 1
        : (data.executeMethod = this.changeForm.executeMethod);
      this.changeForm.executor == "未选择"
        ? 1
        : (data.executor = this.changeForm.executor);
      this.changeForm.missionId == "未选择"
        ? 1
        : (data.missionId = this.changeForm.missionId);
      this.changeForm.priority == "未选择"
        ? 1
        : (data.priority = this.changeForm.priority);
      this.changeForm.reviewer == "未选择"
        ? 1
        : (data.reviewer = this.changeForm.reviewer);
      this.changeForm.scriptMode == "未选择"
        ? 1
        : (data.scriptMode = this.changeForm.scriptMode);
      this.changeForm.scriptModeFlag == "未选择"
        ? 1
        : (data.scriptModeFlag = this.changeForm.scriptModeFlag);
      this.changeForm.transId == "未选择"
        ? 1
        : (data.transId = this.changeForm.transId);
      var _this = this;
      Request({
