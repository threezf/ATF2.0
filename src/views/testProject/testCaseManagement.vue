...
: "评审通过"
                  ...
                  <el-table-column label="执行者" property="executorName" width="120" />
...
" size="small"></el-input>
                    ...
                    <el-col :span="7" :offset="1">
                      <el-form-item label="测试任务" prop="submissionId" label-width="40%">
                        <el-select class="selectWidth" v-model="

addForm.submissionId

" size="small">
                          <el-option v-for="item in missionList" :key="item.id" :label="
                  ...
                  <el-row>
                    <el-col :span="7">
                      <el-form-item label="被测系统" prop="autName" label-width="40%">
                        <el-select class="selectWidth" v-model="addForm.autId" size="small" @change="

transChange($event)

">
                          <el-option v-for="item in autList" :key="item.id" :label="
...
">
                          <el-option v-for="item in transList" :key="item.id" :label="
...
" size="small">
                          <el-option v-for="item in caseTypeList" :key="item.id" :label="item.label" :value="item.value">
                          </el-option>
                        </el-select>
                      </el-form-item>
                    </el-col>
...
" size="small">
                          <el-option v-for="item in priorityList" :key="item.id" :label="item.label" :value="item.value">
                          </el-option>
                        </el-select>
                      </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="7">
                      <el-form-item label="作者" prop="author" label-width="40%">
                        <el-select class="selectWidth" v-model="addForm.author" size="small">
                          <el-option v-for="item in userList" :key="item.id" :label="
...
" size="small">
                          <el-option v-for="item in useStatusList" :key="item.id" :label="item.label" :value="item.value">
                          </el-option>
                        </el-select>
                      </el-form-item>
                    </el-col>
...
" size="small">
                          <el-option v-for="item in executeMethodList" :key="item.id" :label="item.label" :value="item.value">
                          </el-option>
                        </el-select>
                      </el-form-item>
                    </el-col>
...
" size="small">
                          <el-option v-for="item in scriptModeList" :key="item.id" :label="item.label" :value="item.value">
                          </el-option>
                        </el-select>
                      </el-form-item>
                    </el-col>
                  ...
                  <el-row>
                    <el-col :span="24">
                      <el-form-item label="备注" prop="note" label-width="11.5%">
                        <el-col :span="23">
                          <el-input type="textarea" placeholder="请输入内容" v-model="
                    ...
                    <el-form ref="addNodeForm" v-if="item.display" :model="item.addNodeForm">
                      ...
                      <el-row>
                        <el-col :span="18" :offset="2">
                          <el-form-item label="流程节点编号" prop="actioncasecode" label-width="35%" required>
                            <el-col :span="6">
                              <el-input v-model="
...
" type="primary" size="small" icon="el-icon-arrow-down">
                                隐藏详情
                              </el-button>
                              <el-button @click="
...
" v-else type="primary" size="small" icon="el-icon-arrow-down">
                                显示详情
                              </el-button>
                            </el-col>
                            <el-col :span="5" :offset="1">
...
">
                                <el-option v-for="item in autList" :key="
...
">
                                <el-option v-for="item in transList" :key="
...
" size="small">
                                <el-option v-for="item in templateList" :key="
...
">
                        ...
                        <el-row>
                          <el-col :span="7">
                            <el-form-item label="动作标识" prop="actioncode" label-width="40%" required>
                              <el-input v-model="
...
" size="small"></el-input>
                          ...
                          <el-col :span="7" :offset="1">
                            <el-form-item label="步骤顺序号" prop="steporder" label-width="40%" required>
                              <el-input v-model="
...
" size="small">
                                <el-option v-for="item in executeMethodList" :key="
...
" size="small">
                                <el-option v-for="item in scriptModeList" :key="
...
">
      ...
      <el-dialog title="更改多种用例信息" :visible.sync="dialogVisibleC" width="65%">
        <el-tabs v-model="activeName" type="card">
          ...
          <el-form ref="changeForm" :model="changeForm">
            ...
            <el-row>
              <el-col :span="7">
                <el-form-item label="测试任务" prop="missionId" label-width="40%">
                  <el-select class="selectWidth" v-model="
...
" size="small">
            ...
            <el-row>
              ...
              <el-col :span="11">
                <el-form-item label="评审者" prop="executor" label-width="25%">
                  <el-select class="selectWidth" v-model="
...
" :value="item.id">
            ...
            <el-row>
              ...
              <el-col :span="11">
                <el-form-item label="执行方式" prop="executeMethod" label-width="25%">
                  <el-select class="selectWidth" v-model="
...
" size="small">
      ...
      <el-dialog :title="title" :visible.sync="dialogVisibleQ" width="50%">
        <el-form :disabled="!changeFlag" ref="addForm" :model="addForm">
          <el-row>
            <el-col :span="11">
              <el-form-item label="用例编号" prop="casecode" label-width="40%" required>
                <el-input v-model="
...
" size="small">
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item label="测试意图" prop="testdesign" label-width="20%" required>
...
"></el-input>
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item label="前置条件" prop="prerequisites" label-width="20%" required>
                <el-input type="textarea" v-model="
...
"></el-input>
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item label="测试步骤" prop="teststep" label-width="20%" required>
                <el-input type="textarea" v-model="
...
"></el-input>
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item label="预期结果" prop="expectresult" label-width="20%" required>
                <el-input type="textarea" v-model="
...
"></el-input>
          ...
          <el-row>
            <el-col :span="22">
              <el-form-item label="附加检查点" prop="checkpoint" label-width="20%" required>
                <el-input type="textarea" v-model="
