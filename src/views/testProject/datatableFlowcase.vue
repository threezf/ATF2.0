...
<div class="page-inner datatableFlowCaseStyle">
    <el-container>
        <el-main>
            <el-row>
                <el-button type="primary" size="small" class="leftButton" icon="el-icon-refresh-right" @click="toggleSingle">切换单用例显示
                </el-button>
            </el-row>
            <el-card class="leftCard">
                <!-- <div class="flowTitle">流程用例</div> -->
                <el-table :data="flowTestcaseInfos" class="tableLeft" @current-change="handleCurrentChange" border stripe highlight-current-row>
                    <el-table-column align="center" label="流程用例列" prop="casecode" width="217px">
                    </el-table-column>
                </el-table>
            </el-card>
            <el-card class="rightCard">
                <el-row class="titleRow">
                    ...
                    <el-col class="rightButtons" :span="8">
                        <el-button type="primary" size="small" icon="el-icon-edit" @click="edit">编辑
                        </el-button>
                        <el-button type="primary" size="small" icon="el-icon-edit" @click="saveFlowTestcaseInfo">提交修改
                        </el-button>
                    </el-col>
                </el-row>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" class="dialog" width="47%">
        <el-table :data="dialogTableData" stripe border highlight-current-row>
            ...
            <el-table-column label="操作项" min-width="40%">
                <template slot-scope="scope">
                    {{scope.row.ui? "UI: " + scope.row.ui + " 元素: " + scope.row.element: scope.row.classType}}
                </template>
            </el-table-column>
            <el-table-column label="方法" width="70px" prop="method">
            </el-table-column>
            <el-table-column label="参数" min-width="50%">
                <template slot-scope="scope">
        ...
        <el-row class="buttonsRow">
            <el-button type="warning" size="small" @click="handleCancel" plain>取消
            </el-button>
            <el-button type="primary" size="small" @click="handleSure">确定
            </el-button>
        </el-row>
    </el-dialog>
</div>
...
export default {
    ...
    methods: {
        ...
        toggleSingle() {
            this.$router.push({
                path: '/testProjectIndext/datatable'
            })
        },
        //编辑事件
        edit() {
