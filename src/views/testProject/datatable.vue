	...
	<div class="page-inner">
		...
		<el-dialog
			...
			<div>
				...
				<el-table border ref="multipleTable" :data="beforeOperationRows" tooltip-effect="dark" style="width: 100%"
									@selection-change="handleSelectionChange1" row-key="id" class="sortable1">
			...
			<div>
				...
				<el-table border ref="multipleTable" :data="afterOperationRows" tooltip-effect="dark" style="width: 100%"
									@selection-change="handleSelectionChange2" row-key="id" class="sortable2">
					<el-table-column label="排序" width="55">
						<template slot-scope="scope">
							<i :id='scope.row.date' class="el-icon-sort" style="color:#F56C6C;font-size:16px;cursor: pointer"></i>
						</template>
