    ...
    <el-table :data="treeData" style="width: 100%;margin-bottom: 20px;" row-key="id" border highlight-current-row stripe :tree-props="{children: 'childNodeList'}">
        ...
        <el-table-column label="类型" align="center">
            <template slot-scope="scope">
                <el-tag v-if="scope.row.type === 0" type="success">顶部菜单
                </el-tag>
                <el-tag v-else-if="scope.row.type === 1" type="primary">左侧子菜单
                </el-tag>
                <el-tag v-else type="info">功能
                </el-tag>
            </template>
        </el-table-column>
        <el-table-column prop="url" align="center" label="菜单URL">
        </el-table-column>
        <el-table-column prop="perms" align="center" label="授权标识">
        </el-table-column>
    </el-table>
</page>
</template>
