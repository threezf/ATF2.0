...
<div class="page-inner">
    ...
    <el-dialog width="24%" :title="dialogTitles[titleIndex]" :visible.sync="dialogVisible">
        ...
        <el-row class="dialogRowStyle">
            <el-button v-if="titleIndex == 0" type="primary" size="small" @click="addSure">添加
            </el-button>
            <el-button v-else-if="titleIndex === 1" type="primary" size="small" @click="updateSure">修改
            </el-button>
            <el-button type="warning" size="small" plain @click="cancel">{{titleIndex === 2? '关闭': '取消'}}
            </el-button>
        </el-row>
    </el-dialog>
    <el-dialog title="分配权限" width="30%" :visible.sync="roleDialogVisible">
        ...
        <el-row class="roleMenusRow">
            <el-button size="small" type="primary" @click="assignPermissions">确认分配
            </el-button>
            <el-button size="small" type="warning" plain @click="roleDialogVisible = false">取消分配
            </el-button>
        </el-row>
    </el-dialog>
</div>
