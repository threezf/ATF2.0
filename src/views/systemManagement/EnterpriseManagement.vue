...
<page>
    ...
    <el-table class="table" border stripe :data="enterpriseList" highlight-current-row>
        ...
        <el-table-column label="操作" width="200px">
            <template slot-scope="scope">
                ...
                <el-button type="info" size="small" @click="show(1,scope.row)">编辑
                </el-button>
            </template>
        </el-table-column>
    </el-table>
            ...
            <el-row>
                <el-col :span="11">
                    <el-form-item label="密码" prop="password" v-show="flag==0" required>
                        <el-input :disabled='disabled' type="password" v-model="form.password" auto-complete="off" size="small"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="11" :offset="1">
                    <el-form-item label="确认密码" prop="checkPassword" v-show="flag==0" required>
                        <el-input :disabled='disabled' type="password" v-model="form.checkPassword" auto-complete="off" size="small"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            if (_this.radio === false) {
                ...
                Request({
                    ...
                    Request({
                        ...
                        method: 'post',
                        params: {
                            companyName: _this.selectCompany
                        }
                    }).then((res) => {
                        Request({
