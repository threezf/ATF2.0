				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="URL Path" prop="urlPath" class="change-label-calss">
							<el-select size="small" v-model="caseData.protocol" placeholder="请选择" style="width:12.5%">
								<el-option
							...
							<el-select size="small" v-model="caseData.method" placeholder="请选择" style="width:12.5%">
								<el-option
