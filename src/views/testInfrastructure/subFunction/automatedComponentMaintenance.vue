          ...
          <el-form>
            <el-form-item label="控件名称" label-width="200px">
              <el-select v-model="selectedControlsName" @change="changeControlName">
                <el-option v-for="(item,index) in controlsName" :key="index" :value="item.name"></el-option>
              </el-select>
            </el-form-item>
          </el-form>
        </div>
        <div class="mainDiv">
          ...
          <el-form>
              ...
              <el-col :span="10" :offset="2">
                <el-form-item label="默认方法" label-width="200px">
                  <el-select class="formMain" v-model="selectDefaultMethod">
                    <el-option v-for="(item,index) in defaultMethods" :value="item" :key="index"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="10" :offset="0">
                <el-form-item label="继承标志" label-width="200px">
                  <el-select class="formMain" v-model="selectedExtendsFlag">
                    <el-option v-for="(item,index) in extendsFlag" :value="item" :key="index"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              <el-col :span="10" :offset="2">
                <el-form-item label="继承可见性" label-width="200px">
                  <el-select class="formMain" v-model="selectedExtendsVisible">
                    <el-option v-for="(item,index) in extendVisible" :value="item" :key="index"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row style="margin-top: 20px">
              <el-col :span="10" :offset="0">
                <el-row style="height: 30px; margin: 10px auto 15px auto">
                  ...
                  <el-button type="primary" size="mini" icon="el-icon-plus" plain></el-button>
                  <el-button type="primary" size="mini" plain icon="el-icon-minus"></el-button>
                </el-row>
                <div class="smallTableStyle">
                  ...
                  >
                    ...
                    <el-table-column prop label="属性名" width="230px"></el-table-column>
                    <el-table-column prop label="属性值" width="230px"></el-table-column>
                  </el-table>
                </div>
              </el-col>
              <el-col :span="10" :offset="2">
            ...
            <el-row>
              ...
              <el-col>
                <el-button type="primary" size="small" class="saveButton">保存</el-button>
              </el-col>
            </el-row>
          </el-form>
        </div>
          ...
          if (res.respCode === "0000") {
            ...
            if (res.arcMethodRespDTOList.length === 0) {
              ...
              for (let i = 0; i < res.arcMethodRespDTOList.length; i++) {
                ...
                _this.displayMethodInformation.push(
                  res.arcMethodRespDTOList[i].name
                );
                _this.selectedDisplayMethodInformation =
                  _this.displayMethodInformation[0];
