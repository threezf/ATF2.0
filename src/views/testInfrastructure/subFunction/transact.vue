    ...
    <el-table class="tableStyle" ref="singleTable" style="width: fit-content; margin-top: 15px" :data="tableData" :default-sort="{ prop: 'modifiedTime', order: 'descending' }" stripe highlight-current-row border>
        <el-table-column label="选择" min-width="3%" align="center">
            <template slot-scope="scope">
                <el-radio v-model="selectedRowIndex" :label="scope.$index" @change="selectRow(scope.$index, scope.row)" :disabled="disableFunc">&nbsp;</el-radio>
            </template>
        </el-table-column>
    ...
    <el-dialog title="绑定swagger" width="31%" :visible.sync="swaggerVisible">
        <el-form>
            ...
            <el-row type="flex" justify="center">
                ...
                <el-button type="warning" size="small" @click="cancelSwagger" plain>取消
                </el-button>
            </el-row>
        </el-form>
    </el-dialog>
