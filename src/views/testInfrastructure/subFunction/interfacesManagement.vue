      ...
      <el-form
        ...
        <el-col
          ...
          <el-form-item
            label="被测系统">
            <el-select
              class="systemSelectSystem"
              placeholder="请选择被测系统"
              v-model="selectSystem"
              @change="selectedSystemChange"
              clearable>
              <el-input 
                v-model="systemNameSearch"  
                class="searchInput">
              </el-input>
              <el-option 
        ...
        <el-col
          ...
          <el-form-item
            label="功能点">
            <el-select
              class="systemSelectFun"
              v-model="selectedTransact"
              placeholder="Nothing Selected"
              @change="tranctChanged"
              clearable>
              <el-input v-model="transactSearchInput"></el-input>
              <el-option
                v-for="(item,index) in transactSearch(titleForm.transactRespDTOs)"
                :key="index"
                :label="item.nameMedium"
                :value="item.id">
              </el-option>
      ...
      <el-form
         ...
         class="manageRow">
          <el-col :span="5">
            <el-form-item
              ...
              <el-select
                class="mainSelect"
                v-model="manageInfo.creatorId">
                <el-option
                  v-for="(item) in manageInfo.creatorList"
                  :key="item.id"
                  :label="item.username"
                  :value="item.id">
                </el-option>
          ...
          <el-col :span="5" :offset="1">
            <el-form-item
              ...
              <el-select
                class="mainSelect"
                v-model="manageInfo.maintainerId">
                <el-option
                  v-for="(item) in manageInfo.maintainerList"
                  :key="item.id"
                  :label="item.username"
                  :value="item.id">
                </el-option>
          ...
          <el-col :span="5" :offset="1">
            <el-form-item
              ...
              <el-select
                class="mainSelect"
                v-model="manageInfo.authenticationMethod">
                <el-option
                  v-for="(item,index) in authenticationMethodList"
                  :key="index"
                  :value="item"
                  :label="item">
                </el-option>
        ...
        <el-row
          ...
          <el-form-item
            ...
            <el-input 
              class="description"
              v-model="manageInfo.description" 
              type="textarea">
            </el-input>
            <el-button
              class="saveButton"
        ...
        <el-tabs
          ...
          <el-tab-pane
            ...
            <el-form-item
              ...
              <el-select
                class="typeSelect"
                v-model="manageInfo.selectedAuthorization">
                <el-option
          ...
          <el-tab-pane
            ...
            <el-form-item
              ...
              <el-input
                class="bodyDes"
                type="textarea"
                v-model="manageInfo.bodyContent">
              </el-input>
            </el-form-item>
          </el-tab-pane>
        </el-tabs>
    ...
    data() {
      return {
        ...
        manageInfo: {
          ...
          creatorId: '', // 创建者
          description: '', // 接口简介
          header: [{"name":"h1","desc":"h3","val":"h2"}], // header里面的文本
          interfaceCode: '', // 接口编码
          maintainerId: '', // 维护者
          method: '', // 请求方法
          name: '', // 接口名称
