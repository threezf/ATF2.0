...
<page>
    ...
    <el-table ref="singleTable" class="tableStyle" highlight-current-row stripe border :data="tableData">
        <el-table-column label="选择" width="60px">
            <template slot-scope="scope">
                <el-radio class="el-radio" v-model="radioSelect" :label="scope.$index" @change="handleRadioSelectChange(scope.$index,scope.row)">&emsp;
                </el-radio>
            </template>
        </el-table-column>
