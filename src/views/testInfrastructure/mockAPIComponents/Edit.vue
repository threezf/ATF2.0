        ...
        <div v-else>
            ...
            <div
                ...
                <ul
                    class="ulRadioButton">
                    <li 
                        v-for='(item,index) in returnHeaders'
                        :key="index">
                        <el-row 
                            class="liRadioButtonRow">
                            <el-col
            ...
            <div
                ...
                <ul
                    class="ulRadioButton">
                    <li 
                        v-for='(item,index) in returnCookies'
                        :key="index">
                        <el-row 
                            class="liRadioButtonRow">
                            <el-col
            ...
            submitInfo(){
                ...
                if(this.httpResponse != null){
                    for(let i = 0;i< this.returnHeadersKey.length;i++){
                        returnHeadersObj[this.returnHeadersKey[i]] = this.returnHeadersValue[i];
                    }
                    for(let i = 0;i< this.returnCookiesKey.length;i++){
                        returnCookiesObj[this.returnCookiesKey[i]] = this.returnCookiesValue[i];
                    }
                }
